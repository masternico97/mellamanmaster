...
CALCULAR_MATRIZ PROC FAR	;SE CALCULA MEDIANTE LA REGLA DE LAPLACE
	MOV BX, 3	;FILA 2
	MOV SI, 1	;COLUMNA 2
	MOV AH, MATRIZ[BX][SI]	;GUARDAMOS DATO FILA 2 COLUMNA 2
	...
	MOV	SI, 1	;COLUMNA 2
	MOV AH, MATRIZ[BX][SI]	;GUARDAMOS DATO FILA 3 COLUMNA 2 EN AH
	...
	MOV BX, 3	;FILA 2
	MOV SI, 0	;COLUMNA 1
	MOV AH, MATRIZ[BX][SI]	;GUARDAMOS DATO FILA 2 COLUMNA 1
	...
	MOV	SI, 0	;COLUMNA 1
	MOV AH, MATRIZ[BX][SI]	;GUARDAMOS DATO FILA 3 COLUMNA 1 EN AH
	...
	ADD AX, CX	;SUMAMOS LA PARTE BAJA DEL TERCER TERMINO AL SEGUNDO
	ADC DX, BX	;SUMAMOS LA PARTE PARTE ALTA DEL TERCER TERMINO AL SEGUNDO + CF
	
	POP CX	;PARTE BAJA DEL PRIMER TERMINO
	POP BX	;PARTE ALTA DEL PRIMER TERMINO
	
	SUB CX, AX	;RESTAMOS LA PARTE BAJA DE SEGUNDO TERMINO + TERCER TERMINO AL PRIMER TERMINO
	SBB BX, DX	;RESTAMOS LA PARTE ALTA DE SEGUNDO TERMINO + TERCER TERMINO + CF AL PRIMER TERMINO
