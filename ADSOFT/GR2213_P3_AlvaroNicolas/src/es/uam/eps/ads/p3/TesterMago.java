...
public class TesterMago {
    public static void main(String[] args) {
        ...
        Camino t = new Trampa(solana, tomelloso, 21, 2, (float) 0);//probRetorno = 0, será comprobada en TesterTrampa
        Explorador julio = new Mago("Julio", 50, solana, 1, Mago.TipoDeMago.HECHICERO);
        Explorador maria = new Mago("Maria", 40, romeral, 1, Mago.TipoDeMago.HADA);
