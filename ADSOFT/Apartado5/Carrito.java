...
public class Carrito extends Articulo {
     ...
     * @param errorAcolchado = false = no acolchado, true = bien acolchado
     * @param errorAnclaje = false = mal anclado, true = bien acolchado
     */
    public Carrito(long codigo, String marca, String modelo, String color, boolean devolucion, int numPiezas, boolean errorAncleaje, boolean errorAcolchado) {
        this.marca = marca;
        this.modelo = modelo;
        this.color = color;
